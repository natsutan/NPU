...
HD_PWD='/media/natu/data/proj/myproj/NPU/fpga_implement/npu8/npu8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log npu8_top.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source npu8_top.tcl
