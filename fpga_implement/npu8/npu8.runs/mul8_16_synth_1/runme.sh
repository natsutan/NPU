...
HD_PWD='/media/natu/data/proj/myproj/NPU/fpga_implement/npu8/npu8.runs/mul8_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul8_16.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul8_16.tcl
