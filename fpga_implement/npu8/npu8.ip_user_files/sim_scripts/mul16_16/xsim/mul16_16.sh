...
#
# Generated by Vivado on Sat Jan 21 17:57:59 JST 2017
# IP Build 1731160 on Wed Dec 14 23:47:21 MST 2016 
#
# usage: mul16_16.sh [-help]
# usage: mul16_16.sh [-lib_map_path]
# usage: mul16_16.sh [-noclean_files]
# usage: mul16_16.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "mul16_16.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot mul16_16 xil_defaultlib.mul16_16 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim mul16_16 -key {Behavioral:q_add_02:Functional:mul16_16} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mul16_16.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul16_16.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mul16_16.sh -help\" for more information)\n"
    exit 1
  fi
